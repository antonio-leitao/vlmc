<script>
  ...
  const options = [
    ...
    {
      name: "Examples",
      description: "List of curated examples.",
      href: "/examples",
      icon: "test",
    },
  ];
